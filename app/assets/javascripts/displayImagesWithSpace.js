$(document).ready(function () {
  document.body.onkeyup = function(e){
      if (e.keyCode == 32) {
        ...
        var randomTopLeft = Math.floor(Math.random() * imagesTopLeft.length);

    document.getElementById("img_1").attributes;
    document.getElementById("img_1").innerHTML = "<img src='" + imagesTopLeft[randomTopLeft] + "' class='img_properties'>" ;
        ...
        imagesTopRight[8] = "https://res.cloudinary.com/dyywnpzbg/image/upload/v1529767605/PICTURE_IMAGE/top_right_12.jpg"
            var randomTopRight = Math.floor(Math.random() * imagesTopRight.length);

    document.getElementById("img_2").attributes;
    document.getElementById("img_2").innerHTML = "<img src='" + imagesTopRight[randomTopRight] + "' class='img_properties'>" ;
        ...
        imagesBottomLeft[8] = "https://res.cloudinary.com/dyywnpzbg/image/upload/v1529767431/PICTURE_IMAGE/bottom_left_12.jpg"
            var randomBottomLeft = Math.floor(Math.random() * imagesBottomLeft.length);

    document.getElementById("img_3").attributes;
    document.getElementById("img_3").innerHTML = "<img src='" + imagesBottomLeft[randomBottomLeft] + "' class='img_properties'>" ;
        ...
        imagesBottomRight[8] = "https://res.cloudinary.com/dyywnpzbg/image/upload/v1529767509/PICTURE_IMAGE/bottom_right_12.jpg"
            var randomBottomRight = Math.floor(Math.random() * imagesBottomRight.length);

    document.getElementById("img_4").attributes;
    document.getElementById("img_4").innerHTML = "<img src='" + imagesBottomRight[randomBottomRight] + "' class='img_properties'>" ;
      }
  }
});
